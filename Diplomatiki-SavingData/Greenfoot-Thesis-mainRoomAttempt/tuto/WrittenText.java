...
public class WrittenText implements Serializable
{
    ...
    public String taskText2(){
        return //"H λέξη μέσα στην παρένθεση ονομάζεται\nπαράμετρος στον κόσμο των προγραμματιστών."
        // +"\nΧρησιμεύει για να στέλνουμε συγκεκριμένες\nτιμές σε μια μέθοδο."
        "Ας δούμε πρώτα πως μοιάζει η μέθοδος use:\n\npublic void use(){εδώ μπαίνει κώδικας}"
        +"\n\nΑυτή είναι η επικεφαλίδα της μεθόδου, η\nοποία περιλαμβάνει όλες τις απαραίτητες\nπληροφορίες για την ενεργοποίησή της και\nονομάζεται υπογραφή (signature) της\nμεθόδου.";
    }

    public String taskText3(){
        return "Μια μέθοδος μπορεί να χρησιμοποιηθεί\nπροκειμένου να αλλάξουμε την κατάσταση\n"
        +"ενός αντικειμένου ή να προσπελάσουμε\nκάποιες από τις πληροφορίες που περικλείει\nτο αντικείμενο.";
        // return "Προκειμένου να μαζέψεις τις πρώτες\nύλες, θα πρέπει να αποκτήσεις νέα δύναμη."
        // +"\nΗ νέα δύναμη σου επιτρέπει να μαζέψεις\nή να χρησιμοποιήσεις μια συγκεκριμένη\nπρώτη ύλη.\n\n"
        // +"Για παράδειγμα:\nAlex.pickUp(wood)";
    }
